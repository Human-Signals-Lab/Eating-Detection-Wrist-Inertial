...
param_sweep_file = csv.writer(open("../results/w_wild_lab_model_eval_wildlong_param_sweep.csv", "wb",0))
...
for eps_parameter in xrange(10, 110, 10):
	for minpts_parameter in xrange(1, 6, 1):
		...
		results_per_participant = csv.writer(open("../results/w_wild_lab_model_eval_wildlong_results_by_participant.csv", "wb",0))
